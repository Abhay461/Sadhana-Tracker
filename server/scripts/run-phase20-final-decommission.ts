...
function scanDirectoryForPattern(dir: string, extensions: string[], pattern: RegExp): { file: string; line: number; content: string }[] {
...
export function runFinalDecommissionExecution() {
  console.log('================================================================');
